...
namespace tema.DataAccess.Migrations
{
    ...
    [Migration("20241205225515_fixedDateAtFeedback")]
    partial class fixedDateAtFeedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tema.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("Tema.Models.Relation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            AlDescription = "Prind",
                            EnDescription = "Parent",
                            SrDescription = "Roditejl"
                        },
                        new
                        {
                            Id = 3,
                            AlDescription = "Kujdestar",
                            EnDescription = "Custodian",
                            SrDescription = "Roditejl"
                        });
                });
            ...
            modelBuilder.Entity("Tema.Models.Child", b =>
                {
                    b.HasOne("Tema.Models.Parent", "Parent")
                        .WithMany()
